...
namespace ControleAcesso.Class
{
    class MainClass {
        ...
        /*private static List<Movimentos> mov = new();
                        ...
                        switch (opcao)
                        {
                            case "1":
                                ...
                                { 
                                    ...
                                    {
                                        case "E":
                                            Expedicao exp = new(nf, double.Parse(pesosai), double.Parse(pesocgd), double.Parse(pesonf), esentido, etipoMovimento, statusMovimento, data, veiculos, pessoas);
                                            mov.Add(exp);
                                            Continuar("MOVIMENTAÇÃO DE EXPEDIÇÂO REGISTRADA");
                                            break;

                                        case "R":
                                            Recebimento rec = new(nf, double.Parse(pesocgd), double.Parse(pesosai), double.Parse(pesonf), esentido, etipoMovimento, statusMovimento, data, veiculos, pessoas);
                                            mov.Add(rec);
                            ...
                            case "2":
                                ...
                                if(msg == "")
                                {
                                    SaidaCarroEmpresa sec = new(Int32.Parse(kms), Int32.Parse(nivcmbs), hrs, des, esentido, etipoMovimento, statusMovimento, data, veiculos, pessoas);
                                    mov.Add(sec);
                            ...
                            case "3":
                                ...
                                EntradaFuncionarios ent = new(ESentido.ENTRADA, etipoMovimento, statusMovimento, data, veiculos, pessoas);
                                mov.Add(ent);

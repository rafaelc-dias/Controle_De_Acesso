...
namespace ControleAcesso.Class
{
    public class MovimentoPesagem : Movimento
    {
        ...
        public MovimentoPesagem(string nf, double pesoChegada, double pesoSaida, double pesoNf, ESentido sentido, ETipoMovimento tipoMovimento, string data, Veiculos veiculo, Pessoas motorista, string obs) : base(sentido, tipoMovimento, data, veiculo, motorista,  obs)
        {
            Nf = nf;

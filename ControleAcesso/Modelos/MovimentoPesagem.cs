...
namespace ControleAcesso.Class
{
    public class MovimentoPesagem : Movimento
    {
        ...
        public MovimentoPesagem(double pesoChegada, ESentido sentido , EStatusMovimento statusMovimento, string data, Veiculo veiculo, Pessoa pessoa) : base(sentido, statusMovimento, data, veiculo, pessoa)
        {

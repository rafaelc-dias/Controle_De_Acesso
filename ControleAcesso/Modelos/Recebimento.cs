...
namespace ControleAcesso.Class
{
    public class Recebimento : Movimento
    {
        ...
        public Recebimento(string nf, double pesoChegada, double pesoSaida, double pesoNf, ESentido eSentido, EStatusMovimento statusMovimento, string data, Veiculo veiculo, Pessoa pessoa) : base(eSentido, statusMovimento, data, veiculo, pessoa)
        {
            Nf = nf;
